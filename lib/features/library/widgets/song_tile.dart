...
import 'package:guitar_buddy/features/library/pages/song_view_page.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return PopupMenuButton(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(
          onTap: () {
            ref.read(newSongTitleProv).text = song.title;
            ref.read(newSongArtistProv).text = song.artist;
            ref.read(newSongContentProv).text = song.content;
            Navigator.push(
              context,
              MaterialPageRoute(
